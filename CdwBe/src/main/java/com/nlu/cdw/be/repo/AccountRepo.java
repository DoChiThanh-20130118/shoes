...
public interface AccountRepo extends JpaRepository<Account, Long> {
    ...
    @Query("SELECT distinct new com.nlu.cdw.be.domain.dto.RespAccountDto( a.id, a.username, a.createDate, a.modifyDate, a.isActive , r.name," +
    ...
    @Query("SELECT new com.nlu.cdw.be.domain.dto.RespAccountDto(a.id, a.username, a.createDate, a.modifyDate, a.isActive , r.name," +
            " ad.fullname, ad.gender, ad.phone, ad.email, ad.address, ad.birthDate) FROM Account a " +
            "inner join AccountDetail ad on a.id = ad.account.id " +
