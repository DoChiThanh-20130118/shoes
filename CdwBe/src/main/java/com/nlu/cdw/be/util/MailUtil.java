    ...
    public static void sendEmail(Order order) throws MessagingException {
        ...
        Session session = Session.getInstance(props, new javax.mail.Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("dothanhlike10102002@gmail.com", "kedm slxz ubvb fkvj");
            }
        });
        Message msg = new MimeMessage(session);
        msg.setFrom(new InternetAddress("dothanhlike10102002@gmail.com", false));
